...
import { CharacterCreatorData } from './creator-data';
...
class CharacterCreatorUi {
  ...
  private ChangeGender(): void {
    ...
    const characterJson = JSON.stringify(this.character);
    mp.events.call(LocalEvents.CharacterCreatorChangeGender, characterJson);
  }
  ...
  private UpdateCharacterFromMain(form: HTMLFormElement): void {
    ...
    const characterJson = JSON.stringify(this.character);
    mp.events.call(LocalEvents.CharacterCreatorUpdateMain, characterJson);
  }
  ...
  private UpdateCharacterFromClothes(form: HTMLFormElement): void {
    ...
    const characterJson = JSON.stringify(this.character);
    mp.events.call(LocalEvents.CharacterCreatorUpdateClothes, characterJson);
  }
  ...
  private UpdateCharacterFromFace(form: HTMLFormElement): void {
    ...
    const characterJson = JSON.stringify(this.character);
    mp.events.call(LocalEvents.CharacterCreatorUpdateFace, characterJson);
  }
  ...
  private UpdateCharacterFromHair(form: HTMLFormElement): void {
    ...
    const characterJson = JSON.stringify(this.character);
    mp.events.call(LocalEvents.CharacterCreatorUpdateHair, characterJson);
  }
